...
# frame feeds a small function block whose fn calls blockr.viz::ctrl_send():
...
#   Rscript blockr.viz/dev/preview-ctrl-send-profile.R          # port 3838
#   Rscript blockr.viz/dev/preview-ctrl-send-profile.R 3839     # any port
#   BLOCKR_PORT=3839 Rscript blockr.viz/dev/preview-ctrl-send-profile.R
#
...
# block code (blockr.viz::ctrl_send). Wrapped in a constructor so
